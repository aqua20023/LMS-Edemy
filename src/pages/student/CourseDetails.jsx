      ...
      <div className='max-w-xl z-10 text-grey-500'>
        ...
        <p  className='pt-4 md:text-base text-sm'
         ...
         <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <p className='text-grey-500'>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1? 'students':'student'}</p>
            </div>
            <p>Educator <span className='text-blue-600 underline'>GreatStack & Aqua</span></p>
              ...
              <div className='pt-5'>
                {
                  courseData.courseContent.map((chapter,index)=>
                    <div key ={index} className='border border-gray-300 bg-bhite mb-2 rounded'>
                      <div onClick={()=>toggleSection(index)} className='flex items-center justify-between p-4 py-3 cursor-pointer select-none'>
                        ...
                        <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                          {chapter.chapterContent.map((lecture,i)=>(
                            <li key={i} className='flex items-center gap-2 py-1'>
                              ...
                              <div className='flex items-center justify-between w-full text-grey-800 text-xs md:text-default'>
            ...
            <div className='pt-20 pb-10 text-sm md:text-default'>
